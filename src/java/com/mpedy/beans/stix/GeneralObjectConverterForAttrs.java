 ...
 */
@FacesConverter("generalOBJConverterForAttrs")
public class GeneralObjectConverterForAttrs implements Converter {
...
//        return ((GeneralObject) value).getType(); -- old format
        ...
        GeneralObject obj = (GeneralObject) value;
        return (obj.getOldId()==null? "null" : obj.getOldId()) + obj.getId();
